...
export CHROME_OPTS="${CHROME_OPTS_OVERRIDE:- --user-data-dir=/home/chrome/profile --no-sandbox --window-position=0,0 --force-device-scale-factor=1 --disable-dev-shm-usage}"
